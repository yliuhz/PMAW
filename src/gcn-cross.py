...
if __name__=='__main__':
    ...
    # print(dgl_graphs_2[0])
    # print(dgl_graphs_2[0].srcnodes)
    # print(dgl_graphs_2[0].dstnodes)
        ...
        for train_index, test_index in kf.split(inputs):
            ...
            for epoch in range(config['train_epochs']):
                ...
                with torch.no_grad():
                    ...
                    writer.add_scalar('loss/test', mre, epoch)
    ...
    cross_result.to_csv('Out/cross_result_GCN.csv', index=False, encoding='gb18030')
    ...
    plt.savefig('pics/fig-GCN.png')
    plt.show()

    cross_result = {'Real lambda': all_train_labels, 'Predicted lambda': all_train_logits}
    cross_result = pd.DataFrame(cross_result)
    cross_result.to_csv('Out/cross_result_GCN_train.csv', index=False, encoding='gb18030')